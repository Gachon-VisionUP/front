...
const styles = StyleSheet.create({  
  container: {  
    ...
    width: '45%', // Match the width of the background image  
    height: '20%', // Match the height of the background image  
    // borderWidth: 2,  
    // borderRadius: 5,  
    // borderStyle: 'solid'  
  },  
  ...
  backgroundImage: {  
    ...
    width: '90%', // Set width to 100% of the container  
    height: '90%', // Set height to 100% of the container  
