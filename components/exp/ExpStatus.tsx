...
export default function ExpStatus() {
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.table}>
              <View style={[styles.tableRow, styles.tableHeader]}>
                ...
                <Text style={[styles.tableCell, styles.headerCell]}>총 필요 경험치</Text>
              </View>
              {[
                ...
                >
                  ...
                  <Text style={styles.tableCell}>{item.experience.toLocaleString()} do</Text>
                </View>
              ))}
            </View>
          </View>
      ...
      {/* 기존 카드와 연도별 경험치 UI는 그대로 유지 */}
      {/* 전체 누적 경험치 */}
      <View style={[styles.card, { height: 150 }]}>
        <Text style={styles.cardTitle}>전체 누적 경험치</Text>
        ...
        <View style={styles.experienceBarContainer}>
          ...
          <View style={styles.experienceBar}>
            <Image
              ...
              style={[
                styles.truckIcon,
                { left: `${(data.personalExperience / data.totalExperience) * 100 - 5}%` },
              ]}
            />
            <View
              style={[
                ...
                {
                  width: `${(data.personalExperience / data.totalExperience) * 100}%`,
                },
              ]}
            />
            <View
            ...
            >
              <Text style={styles.currentExperienceText}>{data.personalExperience} do</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.card, { height: 260 }]}>
        <Text style={styles.cardTitle}>연도별 / 항목별 누적 경험치</Text>
        {data.yearComparison.map((item, index) => (
          <View key={index} style={styles.yearComparisonRow}>
            <Text
              style={[
                styles.yearText,
                { left: `${(item.experience / data.totalExperience) * 100 - 5}%` },
              ]}
            >
              {item.year}
            </Text>
            <View style={styles.experienceBar}>
              ...
              <View
                style={[
                  styles.experienceProgress,
                  {
                    width: `${(item.experience / data.totalExperience) * 100}%`,
                  },
                ]}
              />
            </View>
            ...
            >
              <Text style={styles.currentYearExperienceText}>{item.experience} do</Text>
            </View>
          </View>
        ))}
      </View>
